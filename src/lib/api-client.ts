 ...
 */
function log(level: LogLevel, message: string, metadata?: RequestMetadata, extra?: unknown): void {
...
export async function apiRequest<T = unknown>(
    ...
    try {
        ...
        if (!response.ok) {
            ...
            const errorBody = data as { error?: { message?: string; code?: string; details?: Array<{ field: string; message: string }> }; retryAfter?: number };
