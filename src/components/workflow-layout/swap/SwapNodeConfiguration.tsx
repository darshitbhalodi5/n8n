...
export function SwapNodeConfiguration({
    ...
    // swapType is always EXACT_INPUT (locked)
    const swapType = SwapType.EXACT_INPUT;
    ...
    const encodeFunctionData = (funcName: 'allowance' | 'approve' | 'balanceOf', args: string[]): string => {
