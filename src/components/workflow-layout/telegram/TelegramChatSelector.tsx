          ...
          <div role="listbox" aria-label="Saved connections">
            {connections.map((conn) => (
              <div
                ...
                className={`flex items-center justify-between p-2 rounded-lg border cursor-pointer transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50 ${
