...
export function OracleNodeConfiguration({
    ...
    return (
        <div className="space-y-4">
                        ...
                        <label className="block">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-3 py-2 pr-10 bg-background border rounded-lg text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 ${
                                        addressError ? "border-red-500" : "border-border"
                                    }`}
                                />
                                {aggregatorAddress && (
                                    <button
                        ...
                        <label className="block">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-3 py-2 pr-10 bg-background border rounded-lg text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 ${
                                        feedIdError ? "border-red-500" : "border-border"
                                    }`}
                                />
                                {priceFeedId && (
                                    <button
            ...
            <Card className={`p-4 ${isConfigValid ? "bg-green-500/10 border-green-500/30" : "bg-orange-500/10 border-orange-500/30"}`}>
                <div className="flex items-center gap-2">
                    {isConfigValid ? (
                        <>
