...
export const SlackNotificationBanner = React.memo(function SlackNotificationBanner({
    ...
    const config = {
        success: {
            icon: <CheckCircle2 className={`${iconClassName} text-success`} />,
            bgClass: "bg-success/10",
            textClass: "text-success",
        },
        error: {
            icon: <XCircle className={`${iconClassName} text-destructive`} />,
            bgClass: "bg-destructive/10",
            textClass: "text-destructive",
        },
        info: {
            icon: <Info className={`${iconClassName} text-info`} />,
            bgClass: "bg-info/10",
            textClass: "text-info",
        },
        warning: {
            icon: <AlertTriangle className={`${iconClassName} text-warning`} />,
